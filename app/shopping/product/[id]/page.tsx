...
// do async as we're in the server component
                ...
                <div className="flex gap-4">
                    ...
                    <div className="flex flex-col justify-between">
                        ...
                        .map((image, i) => (
                            ...
                            />
                            // map through them and show 2 smaller images on the screen
                        ))}
                    </div>
                </div>

                <div className="flex space-x-6 overflow-x-scroll py-2 md:w-[30rem]">
                    {/* map images underneath after the 3rd image */}
